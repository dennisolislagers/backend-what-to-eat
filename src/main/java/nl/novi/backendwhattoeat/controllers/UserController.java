...
public class UserController {
    ...
    public ResponseEntity<Object> addUserAuthority(@PathVariable("username") String username, @RequestBody Map<String, Object> fields, @PathVariable String authority) {
        try {
